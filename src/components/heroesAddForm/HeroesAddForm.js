    ...
    <div className="border p-4 shadow-lg rounded">
      <Formik
        ...
        validationSchema={Yup.object({
          name: Yup.string().min(2, 'Min 2 symbols!').required('Necessary field!'),
          description: Yup.string().min(10, 'More then 9 symbols').required('Necessary field'),
          element: Yup.string().required('Necessary field!'),
        })}
        onSubmit={(values) => {
          const hero = {
            id: uuidv4(),
      ...
      >
        <Form>
          ...
          <div className="mb-3">
            ...
            <Field required className="form-select" id="element" as="select" name="element">
